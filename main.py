...
def test_button():
    driver = webdriver.Chrome(executable_path="/Users/chethp/PycharmProjects/Selenium_Mini2_project/venv/bin/chromedriver")
...
def test_fileupload():
    ...
    driver.switch_to.window(driver.window_handles[1])
    driver.find_element(By.ID, 'myFile').send_keys("/Users/chethp/Desktop/Test.png")
    time.sleep(4)
    driver.find_element(By.ID, 'submit-button').click()
    driver.quit()
...
def Actions():
    ...
    actionChains.click_and_hold(on_element=click_box).perform()
    double_click = click_box.text
    print(double_click)
